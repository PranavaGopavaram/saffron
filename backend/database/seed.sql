...
(1, 1, 'ORD-2025-0001', 3815, 'delivered', 'completed', 1, 497, '2025-06-20', '2025-06-10 14:00:00', '2025-06-18 10:00:00'),
(2, 1, 'ORD-2025-0002', 13275, 'delivered', 'completed', 1, 0, '2025-07-15', '2025-07-05 09:30:00', '2025-07-13 14:00:00'),
(3, 2, 'ORD-2025-0003', 7045, 'delivered', 'completed', 2, 497, '2025-08-10', '2025-07-30 16:00:00', '2025-08-08 11:00:00'),
(4, 3, 'ORD-2025-0004', 24899, 'delivered', 'completed', 3, 0, '2025-09-05', '2025-08-25 11:00:00', '2025-09-03 15:00:00'),
(5, 2, 'ORD-2025-0005', 5809, 'delivered', 'completed', 2, 497, '2025-09-20', '2025-09-10 13:00:00', '2025-09-18 09:00:00'),
(6, 4, 'ORD-2025-0006', 16599, 'delivered', 'completed', 4, 0, '2025-10-10', '2025-09-30 10:00:00', '2025-10-08 12:00:00'),
(7, 1, 'ORD-2025-0007', 9129, 'delivered', 'completed', 1, 497, '2025-11-01', '2025-10-20 15:00:00', '2025-10-30 10:00:00'),
(8, 3, 'ORD-2025-0008', 6225, 'shipped', 'completed', 3, 497, '2026-03-10', '2026-02-28 09:00:00', NULL),
(9, 4, 'ORD-2025-0009', 10799, 'confirmed', 'completed', 4, 0, '2026-03-15', '2026-03-01 11:00:00', NULL),
(10, 2, 'ORD-2025-0010', 4149, 'pending', 'pending', 2, 497, '2026-03-20', '2026-03-02 10:00:00', NULL),
(11, 1, 'ORD-2026-0011', 7459, 'pending', 'completed', 1, 497, '2026-03-15', '2026-03-03 10:00:00', NULL),
(12, 1, 'ORD-2026-0012', 4565, 'confirmed', 'completed', 1, 497, '2026-03-18', '2026-03-04 14:30:00', NULL),
(13, 1, 'ORD-2025-0013', 10799, 'delivered', 'completed', 1, 0, '2025-12-20', '2025-12-10 09:00:00', '2025-12-18 14:00:00'),
(14, 1, 'ORD-2026-0014', 6225, 'delivered', 'completed', 1, 497, '2026-01-15', '2026-01-05 11:00:00', '2026-01-13 10:00:00'),
(15, 1, 'ORD-2026-0015', 16599, 'delivered', 'completed', 1, 0, '2026-02-10', '2026-02-01 16:00:00', '2026-02-08 12:00:00'),
(16, 1, 'ORD-2025-0016', 3735, 'delivered', 'completed', 1, 497, '2025-11-20', '2025-11-10 08:00:00', '2025-11-18 09:00:00');

INSERT INTO order_items (id, order_id, variant_id, seller_id, quantity, unit_price, subtotal, item_status, created_at) VALUES
(1, 1, 1, 1, 2, 2499, 4998, 'delivered', '2025-06-10 14:00:00'),
(2, 1, 6, 1, 1, 1999, 1999, 'delivered', '2025-06-10 14:00:00'),

(3, 2, 4, 1, 1, 21999, 21999, 'delivered', '2025-07-05 09:30:00'),
(4, 2, 7, 1, 1, 3799, 3799, 'delivered', '2025-07-05 09:30:00'),

(5, 3, 15, 2, 1, 12999, 12999, 'delivered', '2025-07-30 16:00:00'),

(6, 4, 5, 1, 1, 49999, 49999, 'delivered', '2025-08-25 11:00:00'),

(7, 5, 3, 1, 1, 11499, 11499, 'delivered', '2025-09-10 13:00:00'),

(8, 6, 36, 3, 1, 32999, 32999, 'delivered', '2025-09-30 10:00:00'),

(9, 7, 35, 2, 1, 17999, 17999, 'delivered', '2025-10-20 15:00:00'),

(10, 8, 28, 4, 1, 11999, 11999, 'shipped', '2026-02-28 09:00:00'),

(11, 9, 4, 1, 1, 21999, 21999, 'confirmed', '2026-03-01 11:00:00'),

(12, 10, 34, 2, 1, 7999, 7999, 'pending', '2026-03-02 10:00:00'),
(13, 11, 3, 1, 1, 11499, 11499, 'pending', '2026-03-03 10:00:00'),
(14, 11, 13, 2, 1, 2899, 2899, 'pending', '2026-03-03 10:00:00'),
(15, 12, 21, 3, 1, 4199, 4199, 'confirmed', '2026-03-04 14:30:00'),
(16, 12, 29, 4, 1, 2199, 2199, 'confirmed', '2026-03-04 14:30:00'),
(17, 13, 4, 1, 1, 21999, 21999, 'delivered', '2025-12-10 09:00:00'),
(18, 14, 28, 4, 1, 11999, 11999, 'delivered', '2026-01-05 11:00:00'),
(19, 15, 36, 3, 1, 32999, 32999, 'delivered', '2026-02-01 16:00:00'),
(20, 16, 11, 1, 1, 6999, 6999, 'delivered', '2025-11-10 08:00:00');
...
(1, 1, 1, 4312, 'credit_card', 'stripe', 'txn_1234567890', 'success', '2025-06-10 14:05:00'),
(2, 2, 1, 13275, 'credit_card', 'stripe', 'txn_2345678901', 'success', '2025-07-05 09:35:00'),
(3, 3, 2, 7542, 'credit_card', 'stripe', 'txn_3456789012', 'success', '2025-07-30 16:05:00'),
(4, 4, 3, 24899, 'credit_card', 'stripe', 'txn_4567890123', 'success', '2025-08-25 11:05:00'),
(5, 5, 2, 6306, 'credit_card', 'stripe', 'txn_5678901234', 'success', '2025-09-10 13:05:00'),
(6, 6, 4, 16599, 'credit_card', 'stripe', 'txn_6789012345', 'success', '2025-09-30 10:05:00'),
(7, 7, 1, 9626, 'credit_card', 'stripe', 'txn_7890123456', 'success', '2025-10-20 15:05:00'),
(8, 8, 3, 6722, 'credit_card', 'stripe', 'txn_8901234567', 'success', '2026-02-28 09:05:00'),
(9, 9, 4, 10799, 'credit_card', 'stripe', 'txn_9012345678', 'success', '2026-03-01 11:05:00'),
(10, 11, 1, 7956, 'credit_card', 'stripe', 'txn_1112131415', 'success', '2026-03-03 10:05:00'),
(11, 12, 1, 5062, 'credit_card', 'stripe', 'txn_1213141516', 'success', '2026-03-04 14:35:00'),
(12, 13, 1, 10799, 'credit_card', 'stripe', 'txn_1314151617', 'success', '2025-12-10 09:05:00'),
(13, 14, 1, 6722, 'credit_card', 'stripe', 'txn_1415161718', 'success', '2026-01-05 11:05:00'),
(14, 15, 1, 16599, 'credit_card', 'stripe', 'txn_1516171819', 'success', '2026-02-01 16:05:00'),
(15, 16, 1, 4232, 'credit_card', 'stripe', 'txn_1617181920', 'success', '2025-11-10 08:05:00');
