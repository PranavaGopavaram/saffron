...
| `backend/src/utils/marketplace-validators.ts` | MODIFY | Add search, sort validation |
| `backend/src/routes/product.routes.ts` | MODIFY | Extract new query params |
| `frontend/src/app/core/services/product.service.ts` | MODIFY | Add search, sort params |
| `frontend/src/app/features/buyer/products/product-list/product-list.component.ts` | MODIFY | Add search/sort state and methods |
| `frontend/src/app/features/buyer/products/product-list/product-list.component.html` | MODIFY | Add search bar, sort dropdown |
| `frontend/src/app/features/buyer/products/product-list/product-list.component.css` | MODIFY | Add search/sort styles |
